...
[UsedImplicitly]
[HarmonyPatch(typeof(JobGiver_HaulCorpseToPublicPlace), methodName: "TryGiveJob")]
public static class CorpseObsessionPatch
{
    ...
    {
        if (!Settings.CorpseObsessionEnabled || Find.TickManager.TicksGame - _snapshot < 60) return;
